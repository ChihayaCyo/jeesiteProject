...
<!-- iCheck -->
<link rel="stylesheet" href="${ctxStatic}/plugins/iCheck/flat/blue.css">
<!-- Morris chart -->
<link rel="stylesheet" href="${ctxStatic}/plugins/morris/morris.css">
<!-- jvectormap -->
<link rel="stylesheet" href="${ctxStatic}/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
<!-- Date Picker -->
...
<link rel="stylesheet" href="${ctxStatic}/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<!-- jvectormap -->
<script src="${ctxStatic}/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${ctxStatic}/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="${ctxStatic}/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="${ctxStatic}/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
